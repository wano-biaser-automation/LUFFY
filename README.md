...
- Many functions still contain TODO markers, including OpenAI logging/timeout and Gemini/Vertex AI integration items
- FSDP and distributed training features need completion


### 🔴 High Priority TODOs

- **API Integration**: OpenAI client initialization/retry logic are implemented; logging, timeout, batch prompts, and Gemini/Vertex AI TODOs remain
...
- **Data Processing**: Core batch dimension folding/unfolding are implemented; memory/view optimization and invalid-dimension handling TODOs remain
